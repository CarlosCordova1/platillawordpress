		<!-- Section -->
								<section>
									...
									<p>Ingeniero En sistemas compuntaciones con Maestría en Tecnologías de informaci'on y comunicación</p>
									<ul class="contact">
										<li class="icon solid fa-envelope"><a href="#">contacto@carloscordova.com</a></li>
									</ul>
								</section>
